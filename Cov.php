...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="Cov.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4" title="Covoiturage"><i class="fa fa-automobile"></i></a>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <!-- Les Postes -->
              <?php 
                include("ConfigPro.php");
                $res5=mysqli_query($c,"SELECT * FROM post,user WHERE post.id=user.id AND post.type='Covoiturage' ORDER BY DATE DESC");
