...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="Page1.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i></a>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
        ...
        <div class="w3-col m12" >
          <div class="w3-card w3-round w3-white" >
            <div class="w3-container w3-padding" style="background-color:Gray;">
              ...
              &#160&#160&#160&#160&#160
                      <input  class="w3-button w3-theme" type="file"  name="file" >
      ...
      if(ISSET($_POST['post']))
         ...
         include("ConfigPro.php");
          ...
          while($row1=mysqli_fetch_array($res3))
                  {
          $res4=mysqli_query($c,"INSERT INTO image VALUES(NULL,'$row1[0]','".$name."')");
    ...
    <!-- Les Postes -->
              <?php 
                include("ConfigPro.php");
                $res5=mysqli_query($c,"SELECT * FROM post,user WHERE post.id=user.id ORDER BY DATE DESC");
