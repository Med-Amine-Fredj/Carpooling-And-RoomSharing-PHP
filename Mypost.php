...
<body class="w3-theme-l5" style="background-color:Black;">
...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="Mypost.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4" title="My Posts"><i class="fa fa-calendar-check-o"></i></a>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <!-- Middle Column -->
    <div class="w3-col m7 w3-Black" style="background-color:LightGray;">
              <?php 
                include("ConfigPro.php");
                $res5=mysqli_query($c,"SELECT DISTINCT * FROM post,user WHERE post.id=user.id AND user.id='$row[0]' ORDER BY DATE DESC");
}
